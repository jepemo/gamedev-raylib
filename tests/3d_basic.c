...
main (int argc, char **argv)
{
  ...
  Vector3 cubesPositions[9]
      = { (Vector3){ 0.0f, 0.0f, 0.0f }, (Vector3){ 2.0f, 0.0f, 0.0f },
          (Vector3){ 4.0f, 0.0f, 0.0f }, (Vector3){ 0.0f, 0.0f, 2.0f },
          (Vector3){ 2.0f, 0.0f, 2.0f }, (Vector3){ 4.0f, 0.0f, 2.0f },
          (Vector3){ 0.0f, 0.0f, 4.0f }, (Vector3){ 2.0f, 0.0f, 4.0f },
          (Vector3){ 4.0f, 0.0f, 4.0f } };

  Color cubeColours[9]
      = { GRAY, YELLOW, RED, BLUE, GREEN, MAGENTA, MAROON, SKYBLUE, PURPLE };
